...
--
-- Table structure for table `CityTestStock`
--

DROP TABLE IF EXISTS `CityTestStock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CityTestStock` (
  `idCityTestStock` int NOT NULL,
  ...
  PRIMARY KEY (`idCityTestStock`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CityTestStock`
--

LOCK TABLES `CityTestStock` WRITE;
/*!40000 ALTER TABLE `CityTestStock` DISABLE KEYS */;
INSERT INTO `CityTestStock` VALUES (1,'bequille',20,'Red',26,1,'City');
/*!40000 ALTER TABLE `CityTestStock` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TestStock`
--
...
CREATE TABLE `TestStock` (
  ...
  `min` int DEFAULT NULL,
  `Type` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idTestStock`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TestStock`
--

LOCK TABLES `TestStock` WRITE;
/*!40000 ALTER TABLE `TestStock` DISABLE KEYS */;
INSERT INTO `TestStock` VALUES (1,'bequille',20,'Red',26,1,'City'),(2,'cadre',10,'Red',26,2,'City');
/*!40000 ALTER TABLE `TestStock` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-06-12  4:48:06
